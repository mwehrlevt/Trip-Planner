...
struct ChicagoActivityDetail: View {
...
struct ChicagoActivityDetail_Previews: PreviewProvider {
    static var previews: some View {
        ChicagoActivityDetail(activity: chicagoActivities[0])
    }
}
